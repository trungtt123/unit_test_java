    ...
    public static ResponseUnitTest UnitTest000() {
		...
		try {
			...
			Response res = given().header("Authorization", Constant.ACCESS_TOKEN)
	                ...
	                .params(params)
	                .when()
	                .get(RequestApiAuctionsByUser.apiPath + RequestApiAuctionsByUser.UnitTest000.subPath);
    ...
    public static ResponseUnitTest UnitTest001() {
		...
		try {
			...
			Response res = given().header("Authorization", Constant.ACCESS_TOKEN)
	                ...
	                .params(params)
	                .when()
	                .get(RequestApiAuctionsByUser.apiPath + RequestApiAuctionsByUser.UnitTest001.subPath);
